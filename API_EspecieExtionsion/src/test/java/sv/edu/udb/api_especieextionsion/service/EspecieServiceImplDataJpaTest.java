// src/test/java/sv/edu/udb/api_especieextionsion/service/EspecieServiceImplDataJpaTest.java
...
import sv.edu.udb.api_especieextionsion.mapping.FakeEspecieMapper;
...
@DataJpaTest
@Import({EspecieServiceImpl.class, FakeEspecieMapper.class}) // <-- importa TB el mapper fake
...
class EspecieServiceImplDataJpaTest {
    ...
    private Especie especie(
            String nc, String nombre, String tipo, String estado,
    ...
    @Test
    @DisplayName("crear: persiste y retorna EspecieResponse mapeado")
    void crear_ok() {
        EspecieResponse res = service.crear(
                req("Panthera onca","Jaguar","FAUNA","EN","Felino nativo", true, LocalDate.now())
        );
    ...
    @Test
    @DisplayName("crear: lanza DuplicateResourceException si nombre científico ya existe")
    ...
    @Test
    @DisplayName("actualizar: lanza DuplicateResourceException si el nombre científico nuevo ya existe")
    void actualizar_conflict() {
        ...
        // e2 mantiene su nombre original
